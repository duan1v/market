<nav class="navbar navbar-expand navbar-light navbar-bg">
    <div class="row col-12">
        <div class="col-1 d-flex justify-content-center align-items-center">
            <h3><a class="dropdown-item" href="{{route('search.list')}}">Market</a></h3>
        </div>
        <div class="col-2">
            <ul class="navbar-nav">
        ...
        <div class="row col-3 d-flex align-items-center">
            <div class="col-4"><h4><a class="dropdown-item" href="{{route('search.list')}}">Contacts</a></h4></div>
            <div class="col-8"><h4><a class="dropdown-item" href="{{route('form.list')}}">Forms</a></h4></div>
        </div>
        <div class="col-6">
